...
public class SessionServiceImpl implements SessionService {
    ...
    private final RedisTemplate<Long, SessionInfo> redisTemplate;

    @Override
    public void saveSession(Long chatId, SessionInfo session) {
    ...
    @Override
    public SessionInfo getSession(Long chatId) {
